...
def set_up_demography(t12, t120, tBT, N_bn, N):
    ...
    admix2 = [msp.MigrationRateChange(time=0.95*t12, rate=0.3, matrix_index=(P1,P2)),
...
np.save('output/norm_10k_admx_03.npy',norm_arr)
np.save('output/bound_10k_admx_03.npy',bound_arr)
np.save('output/conv_10k_admx_03.npy',conv_arr)
np.save('output/TTo_10k_admx_03.npy',TTo_arr)
np.save('output/TT_10k_admx_03.npy',TT_arr)
