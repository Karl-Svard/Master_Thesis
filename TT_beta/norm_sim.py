...
np.save('output/norm_10k.npy',norm_arr)
np.save('output/bound_10k.npy',bound_arr)
np.save('output/conv_10k.npy',conv_arr)
np.save('output/TTo_10k.npy',TTo_arr)
np.save('output/TT_10k.npy',TT_arr)
