...
np.save('output/norm_10k_anc_exp.npy',norm_arr)
np.save('output/bound_10k_anc_exp.npy',bound_arr)
np.save('output/conv_10k_anc_exp.npy',conv_arr)
np.save('output/TTo_10k_anc_exp.npy',TTo_arr)
np.save('output/TT_10k_anc_exp.npy',TT_arr)
