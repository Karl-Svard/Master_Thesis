...
def set_up_demography(t12, t120, f):
    ...
    divergence = [msp.MassMigration(time=t12,source=P2,destination=P1,proportion=1),
                  ...
                  msp.PopulationParametersChange(time=tBT[1], initial_size=Ne, growth_rate=None, population=P1)]
...
np.save('output/mm_results_0admx_anc_bottle.npy',res_list)
np.save('output/bval_0admx_anc_bottle.npy',bval_list)
